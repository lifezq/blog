...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    *{margin:0px;border:0px;padding:0px;}
    ...
    <body>
        <div id="login">
            <div id="title"><a href="<?php echo BLOG_URL; ?>">之晴博客</a> - 完善帐户信息 </div>
                ...
                <form action="<?php echo BLOG_URL; ?>/admin/user_register.php?action=register&op=comAccount" method="post" target="registeriframe">
                    <table id="loginbox" border="0" cellpadding="0" cellspacing="0">
                        ...
                        <tr style="height:30px">
                            ...
                            <td><span id="email_notice" class="notice">&nbsp;请认真填写一个常用的邮箱</span></td>
                        </tr>
                        <tr style="height:30px">
                        ...
                        <tr style="height:30px">
                            <td align="center" colspan="3"><input type="hidden" id="isSubmitOk" name="isSubmitOk" value="1"/> <input  type="submit" value="提 交" class="submit" onClick="if(document.getElementById('isSubmitOk').value=='-1'){ return false; }"/> </td>
                        </tr>
                    </table>
                </form>
                <div id="btnlogin">
    ...
    document.getElementById("isSubmitOk").value='-1';
    if(msg=='-1'){
    _jswrite(document.getElementById("login_notice"),'用户名已经存在');
    }else if(msg=='-2'){
