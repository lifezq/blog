...
?>
                        ...
                        <a href="<?php echo BLOG_URL; ?>admin">
                            <img style="width:15px;height:16px;vertical-align: top;" src="<?php echo BLOG_URL . 'content/uploadfile/com/connect_qq.webp'; ?>" id="login_img" title="<?php echo $_COOKIE['qq-username']; ?>" alt="<?php echo $_COOKIE['qq-username']; ?>">
                        </a>
                        ...
                        <a href="<?php echo BLOG_URL; ?>admin">
                            <img style="width:22px;height:21px;vertical-align: top;" src="<?php echo BLOG_URL . 'content/uploadfile/com/connect_sina.webp'; ?>" id="login_img" title="<?php echo $_COOKIE['sina-username']; ?>" alt="<?php echo $_COOKIE['sina-username']; ?>">
                        </a>
                        ...
                        <a href="javascript:;"  onClick="this.href='<?php echo BLOG_URL; ?>/QQLogin/oauth/qq_login.php';" title="使用腾讯QQ登录"><img src="<?php echo BLOG_URL; ?>/QQLogin/img/qq_login.webp" alt="使用腾讯QQ登录" width="120" height="24"/></a>
                        <!--                                        <a href="javascript:void(0);" onClick="this.href='<?php echo BLOG_URL; ?>weiboSina/';"><img src="<?php echo BLOG_URL; ?>weiboSina/loginButton_24.webp" width="102" height="24" alt="用新浪微博登录" title="用新浪微博登录"/></a>-->
