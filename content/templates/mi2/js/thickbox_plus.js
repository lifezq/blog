...
$("a.thickbox").click(function(){
  ...
  if(pregLogin.test(this.href)){
      //280
      url="/login.html?height=370;width=400";
  }else if(pregReg.test(this.href)){
      //250
      url="/register.html?height=370;width=400";
  }else if(comAccount.test(this.href)){
      //300
      url="/comaccount.html?height=370;width=400";
  }else if(bindAccount.test(this.href)){
      //120
      url="/bindAccount.html?height=240;width=400";
  }
