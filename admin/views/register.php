...
<style type="text/css">
	*{margin:0px;border:0px;padding:0px;}
        ...
        #loginbox{width:390px;height:auto;margin:10px 20px;float:left;display:inline;font-size:12px;}
    ...
    <div style="width:400px;height:auto;overflow: hidden;margin:0px auto;text-align: center;" id="register_box">
        ...
        <table id="loginbox" border="0" cellpadding="0" cellspacing="0">
            ...
            <tr style="height:30px">
                ...
                <td><div class="clear_box"><input class="txtbox" type="text" name="email" id="email"  onblur="checkReg(2,this.value)" /><a class="clear_email" href="javascript:;" node-type="clear" id="clear_email" title="email">×</a> <font color="#f00">*</font><div id="auto-show"></div></td>
