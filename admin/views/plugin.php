  ...
  <tbody>
	...
	?>	
      <tr>
		...
		<a href="./plugin.php?action=<?php echo $plug_action;?>&plugin=<?php echo $key;?>"><img src="./views/images/plugin_<?php echo $plug_state; ?>.webp" title="<?php echo $plug_state_des; ?>" align="absmiddle" border="0"></a>
		</td>
