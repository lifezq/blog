...
<div id="tw">
    ...
    <?php session_start(); if(isset($_SESSION['zq_qqlogin']) && $_SESSION['zq_qqlogin']){ ?><div style="padding:8px 0 0;line-height:25px;"><input type="checkbox" name="is_tongbu" value="1" checked="checked"/> 同步至QQ空间</div><?php } ?>
