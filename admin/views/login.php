...
<div class="login-main">
	...
	<div class="login-logo"><a href="<?php echo WEB_ROOT; ?>" target="_blank" style="margin-left:3px;"><img src="./views/images/login_logo.webp" alt=之晴博小说" width="288" height="68" /></a></div>
	<small>&nbsp;</small>
	...
	<div class="back"><a href="../">&laquo;返回首页</a> | <a href="javascript:void(0);" >忘记密码?</a></div>
</div>
<?php if ($error_msg): ?>
