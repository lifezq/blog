...
<div id="post_button">
    ...
    <?php session_start(); $username=explode('|',$_COOKIE[AUTH_COOKIE_NAME]); if((isset($_SESSION['zq_qqlogin']) && $_SESSION['zq_qqlogin']) || $username[0] == 'admin'){ ?><input type="checkbox" name="is_tongbu" value="1" <?php if($username[0]!='admin'){?>checked="checked"<?php }?> /> 同步至QQ空间<?php } ?>
</div>
