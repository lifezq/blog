...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>注册  - <?php echo SITE_TITLE; ?> </title>
    </head>
    <style type="text/css">
    *{margin:0px;border:0px;padding:0px;}
    ...
    <body>
        <div id="login">
            <div id="title"><a href="<?php echo BLOG_URL; ?>"><?php echo SITE_TITLE; ?></a> - 用户注册  <span class="registered">已经注册,现在就去<a href="javascript:void(0)" onClick="login()"><strong>登录</strong></a>吧。</span></div>
